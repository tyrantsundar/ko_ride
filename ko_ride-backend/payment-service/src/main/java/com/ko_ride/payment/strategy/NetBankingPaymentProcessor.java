...
@Component
@Slf4j
public class NetBankingPaymentProcessor implements PaymentProcessingStrategy{
    @Override
    public String process(Long paymentId, PaymentMethodDto paymentMethodDto) {
//        log.info("PaymentId {} paid amount {} via NetBanking payment processor.",paymentId,paymentMethodDto.getAmount());
