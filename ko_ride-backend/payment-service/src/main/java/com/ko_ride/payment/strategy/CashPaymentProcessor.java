...
@Slf4j
@Component
public class CashPaymentProcessor implements PaymentProcessingStrategy{
    @Override
    public String process(Long paymentId, PaymentMethodDto paymentMethodDto) {
//        log.info("PaymentId {} paid amount {} via Cash payment processor.",paymentId,paymentMethodDto.getAmount());
